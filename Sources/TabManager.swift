...
// NOTE: GitHubPullRequestRESTPoller was removed during upstream sync (April 2026).
// Upstream refactored PR polling into per-repo caching with TaskGroup-based parallel
// fetching (#2585, #2662). See refreshTrackedWorkspacePullRequestsIfNeeded().
